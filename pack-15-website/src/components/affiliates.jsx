    ...
    <>
      <div className='row'>
        ...
        <div className='subcontent'>
          ...
          Sewell-Eagle District of the Council.
          <br />
          <br />
          It is the mission of the Istrouma Area Council, Boys Scouts of
          America, to build character, citizenship and total fitness while
          preparing young people to make ethical and moral choices over the
          course of their lifetimes by instilling in them the values of the
          Scout Oath and Law.
        </div>
      </div>
    </>
